...
CREATE TABLE PRODUCTO(
    ...
    PRODUCTO_STOCKACTUAL BIGINT DEFAULT 0,
...
CREATE TABLE FACTURA(
    ...
    FACTURA_CODIGO VARCHAR(16),
    FACTURA_FECHA TIMESTAMP NOT NULL,
    PRIMARY KEY (FACTURA_ID),
    UNIQUE(FACTURA_CODIGO)
)
/*sql-break*/
CREATE TABLE FACTURAUNIDAD(
    FACTURAUNIDAD_ID CHAR(16) FOR BIT DATA NOT NULL,
    FACTURAUNIDAD_IDPRODUCTO CHAR(16) FOR BIT DATA NOT NULL,
    FACTURAUNIDAD_CODIGOPRODUCTO VARCHAR(16) NOT NULL,
    FACTURAUNIDAD_DESCRIPCIONPRODUCTO VARCHAR(128) DEFAULT '',
    FACTURAUNIDAD_PRECIOCOMPRA BIGINT DEFAULT 0,
    FACTURAUNIDAD_CANTIDAD BIGINT DEFAULT 0,
    FACTURAUNIDAD_FACTURA_ID CHAR(16) FOR BIT DATA REFERENCES FACTURA(FACTURA_ID),
    PRIMARY KEY (FACTURAUNIDAD_ID)
)
/*sql-break*/
CREATE TABLE VENTA(
    VENTA_ID CHAR(16) FOR BIT DATA NOT NULL,
    VENTA_CODIGO VARCHAR(16),
...
CREATE TABLE VENTAUNIDAD(
    ...
    VENTAUNIDAD_IDPRODUCTO CHAR(16) FOR BIT DATA NOT NULL,
    VENTAUNIDAD_CODIGOPRODUCTO VARCHAR(16) NOT NULL,
    VENTAUNIDAD_DESCRIPCIONPRODUCTO VARCHAR(128) DEFAULT '',
    VENTAUNIDAD_PRECIOVENTA BIGINT DEFAULT 0,
    VENTAUNIDAD_CANTIDAD BIGINT DEFAULT 0,
    VENTAUNIDAD_VENTA_ID CHAR(16) FOR BIT DATA REFERENCES VENTA(VENTA_ID),
