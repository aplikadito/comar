 ...
 * @author aplik
 */
public class DeleteProductoBatch {

    private static final int DEFAULT_BATCH = 1000;
    private Connection connection;

    public DeleteProductoBatch(Connection connection) {
