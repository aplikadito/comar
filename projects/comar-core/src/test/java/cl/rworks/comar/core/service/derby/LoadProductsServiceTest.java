...
import cl.rworks.comar.core.service.derby.SearchProductByCodeOrDescription;
...
public class LoadProductsServiceTest {
    ...
    public static void main(String[] args) {
        try (Connection connection = TestUtils.createConnection()) {
            List<ComarProduct> products = SearchProductByCodeOrDescription.serve(connection, "cafe");
